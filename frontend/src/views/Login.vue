ปรับโทนกลับมาใช้ **เขียวเข้มลึก (Deep Forest Green)** ตามแบบฉบับดั้งเดิมให้แล้วครับ!

โดยรอบนี้เน้นการเลเยอร์เฉดสีเขียวเข้มหลายๆ ระดับ ตั้งแต่เขียวดำอมเทา เขียวมรกตเข้ม ไปจนถึงเขียวสดสว่างเล็กน้อย ทำให้โทนสียังคงความสุขุม น่าเชื่อถือ และเห็นมิติความแตกต่างของชั้นสีชัดเจนขึ้นครับ
